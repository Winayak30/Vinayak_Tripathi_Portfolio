...
const skills = [
  ...
  { id: '02', abbr: 'Rs', name: 'Rust' },
  { id: '03', abbr: 'Sb', name: 'Spring Boot' },
  { id: '04', abbr: 'Pg', name: 'PostgreSQL' },
  { id: '05', abbr: 'Rd', name: 'Redis' },
  { id: '06', abbr: 'Dk', name: 'Docker' },
  { id: '07', abbr: 'Gc', name: 'GCP' },
  { id: '08', abbr: 'Fb', name: 'Firebase' },
  { id: '09', abbr: 'Gt', name: 'Git' },
  { id: '10', abbr: 'Re', name: 'REST APIs' },
  { id: '11', abbr: 'Sm', name: 'State Machines' },
  { id: '12', abbr: 'Ed', name: 'Event-Driven' },
  { id: '13', abbr: 'Ds', name: 'DSA' },
  { id: '14', abbr: 'Oo', name: 'OOP' },
  { id: '15', abbr: 'Os', name: 'OS' },
  { id: '16', abbr: 'Db', name: 'DBMS' },
];
